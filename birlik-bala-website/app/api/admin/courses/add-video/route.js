...
export async function POST(request) {
  ...
  try {
    ...
    console.log("[Admin Add Video API] Cookies:", cookieHeader || "none");
    ...
    try {
      ...
      console.error("[Admin Add Video API] Ошибка парсинга JSON:", parseError.message);
      return new Response(
        JSON.stringify({
    ...
    console.error("[Admin Add Video API] Ошибка запроса:", { name: err.name, message: err.message });
